...
em uma mão de jogo de truco (1 = AS; 2 = 2; 3 = 3; 7 = 7; 11 = Valete; 12 = Dama;
13 = Rei). O algoritmo deve imprimir na tela a palavra "TRUCO" (se APENAS UMA das
três cartas for AS, 2 ou 3), "SEIS" (se APENAS DUAS das três cartas for AS, 2 ou 3)
...
public class Uni4Exe13 {
    public static void main(String[] args) {
        ...
        System.out.println("Digite as três cartas abaixo: ");
